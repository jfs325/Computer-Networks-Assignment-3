...
// using host, get IP address of host
// using IP address and port, create socket
// attempt connection using socket
...
// using strnstr, find the end point of the http_buffer
// if there is an end point, return the length to the endpoint of the buffer
//if cannot find the end, return error
...
//iterates through http buffer, trying to find the content length header portion of the buffer by looking for "Content length:"
//if it finds content length, then it converts the value of content length to an integer and returns it
//if it does not find it, then it returns 0 and prints an error
